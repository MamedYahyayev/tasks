...
namespace demo.Command
{
    ...
    {
        public VoidReactiveCommand(Func<Unit, IObservable<Unit>> execute,
            IObservable<bool> canExecute, IScheduler outputScheduler) :
            base(execute, canExecute, outputScheduler, outputScheduler)
        { }

        public static VoidReactiveCommand Create(Action execute, IObservable<bool> canExecute = null,
    ...
    {
        public VoidReactiveCommand(Func<T, IObservable<Unit>> execute,
            IObservable<bool> canExecute, IScheduler outputScheduler) :
            base(execute, canExecute, outputScheduler, outputScheduler)
        { }

        public static VoidReactiveCommand<T> Create(Action<T> execute,
